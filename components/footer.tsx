    ...
    <footer className="bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-4 max-w-md">
              Your exclusive hair sanctuary where artistry meets luxury. We craft personalized transformations that
              celebrate your unique beauty and elevate your confidence to new heights.
            </p>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; 2024 Glam Nest. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
